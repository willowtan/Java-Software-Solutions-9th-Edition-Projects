...
import java.util.Scanner;
    public class MoneyToCoins {
        public static void Stuff(String[]args) {
            ...
            ten = total / 10; total = total %10;
            five = total / 5; total = total % 5;
            one = total / 1; total = total % 1;
            quarter = total / .25; total = total % .25;
            dime = total / .10; total = total % .10;
            nickel = total / .05; total = total % .05;
            penny = total / .01; total = total % .01;
