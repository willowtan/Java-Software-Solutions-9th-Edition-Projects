...
public class DistanceFormula {
    public static void main(String[]args) {
        ...
        System.out.println("x1:");int x1 = scan.nextInt();
        System.out.println("y1:");int y1 = scan.nextInt();
        System.out.println("x2:");int x2 = scan.nextInt();
        System.out.println("y2:");int y2 = scan.nextInt();
